  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          {!isSignedIn ? (
            <SignInButton mode="modal">
              <button className="bg-brand-500 hover:bg-brand-600 text-white px-3 py-1.5 sm:px-5 sm:py-2 rounded-full text-xs sm:text-base font-medium transition-all hover-scale shadow-lg shadow-brand-500/30 whitespace-nowrap">
                Sign In / Register
              </button>
            </SignInButton>
          ) : (
        ...
        <section className="py-16 sm:py-20 lg:py-28 px-6 bg-gray-50 dark:bg-gray-900/50">
          <div className="max-w-5xl mx-auto text-center">
            <p className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight tracking-tight">
              ...
              <span className="text-gray-800 dark:text-gray-100">
                {" "}
                needing coverage for the dinner rush,{" "}
              </span>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl group relative flex flex-col">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 flex-1 space-y-6">
                <div>
                  <h4 className="text-base font-semibold text-gray-900 dark:text-white mb-3 pb-2 border-b border-gray-200 dark:border-gray-700 uppercase tracking-wider">
                    The Problem
                  </h4>
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">•</span>Want to
                      pick up an extra shift but don't know who needs help right
                      now.
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">•</span>Hard to
                      find shifts in your immediate area on short notice.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li className="flex items-start">
                      ...
                      <span>
                        ...
                        Pick up shifts when and where you want.
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">✓</span>Fit
                      work seamlessly into your schedule.
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">✓</span>Support
                      local businesses. Our app is geofenced to list only those
                      needing help within a 45-mile radius.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="rounded-3xl overflow-hidden shadow-2xl group relative flex flex-col">
              ...
              <div className="bg-white dark:bg-gray-900 p-8 flex-1 space-y-6">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">•</span>Someone
                      called out sick and you need a server for the rush, stat.
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">•</span>No easy
                      way to connect with experienced individuals ready to step
                      in.
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600 dark:text-gray-400">
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">✓</span>Get the
                      staff you need, exactly when you need them.
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">✓</span>Find
                      high-rated, experienced servers nearby.
                    </li>
                    <li className="flex items-start">
                      <span className="mr-2 text-brand-500 mt-1">✓</span>Connect
                      instantly and keep your floor running smoothly.
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400">
                We're here to help you keep your restaurant fully staffed.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      name="firstName"
                      required
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none transition-all"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                <button
                  ...
                  className="w-full bg-brand-600 hover:bg-brand-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-4 rounded-lg font-bold transition-all hover-scale shadow-lg"
                >
      ...
      <footer className="py-8 border-t border-gray-200 dark:border-gray-800 text-center text-gray-500 text-sm">
        <p>
          &copy; {new Date().getFullYear()} serverNetwork. All rights reserved.
        </p>
      </footer>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 max-w-md w-full shadow-2xl relative">
            ...
            <form className="space-y-4">
              ...
              <SignUpButton mode="modal">
                <button
                  type="button"
                  className="w-full bg-brand-500 hover:bg-brand-600 text-white px-8 py-3 rounded-lg font-bold transition-all hover-scale shadow-lg shadow-brand-500/30 mt-4 flex items-center justify-center gap-2"
                >
                  Continue with Clerk
                  <svg
                    className="w-4 h-4"
